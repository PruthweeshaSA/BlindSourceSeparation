...
class CauchyNMF(NMFbase):
    def __init__(self, n_basis, domain=2, algorithm='naive-multiplicative', eps=EPS):
        super().__init__(n_basis=n_basis, eps=eps)
    ...
    def update_once(self):
        if self.algorithm == 'naive-multiplicative':
...
if __name__ == '__main__':
    ...
    os.makedirs('data/NMF/Cauchy/naive-multiplicative', exist_ok=True)
    ...
    #_test(metric='Cauchy', algorithm='naive-multiplicative')
